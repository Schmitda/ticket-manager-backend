...
import {
  UserInterface
} from '../../models/interface/user/user.interface';
import {
  UserMongoose
} from '../../models/mongoose-class/UserMongooseClass';
import {
  UserMongooseModel
} from '../../models/UserMongoose';
import {
  UserDBDInterface
} from '../../models/database-document-interface/UserDBDInterface';
import {
  ExpressRequest
